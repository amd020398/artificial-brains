            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse " id="navbarNavDropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu z-index-2" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="#">PROCESSED_MEATBacon </a></li>
                            <li><a class="dropdown-item" href="#">PROCESSED_MEATCorned beef</a></li>
                            <li><a class="dropdown-item" href="#">pouch with pickling juices</a></li>
                            <li><a class="dropdown-item" href="#">PROCESSED_MEATHam</a></li>

                            <li><a class="dropdown-item" href="#">PROCESSED_MEATHam</a></li>
                            <li><a class="dropdown-item" href="#"></a>PROCESSED_MEATHot dogs</li>
                            <li><a class="dropdown-item" href="#"></a>PROCESSED_MEATLunch meats</li>
                    </li>
                    </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu z-index-2" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="#">FROZEN_ITEMBread Dough</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu z-index-2" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="#">ITEMMain dishes or meals </a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu z-index-2" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="#">SHELF_ITEMDiet powder mixes</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu z-index-2" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="#">CRACKERSCrackers</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="content">
            ...
            <div class="items">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo '<input type="button" value="-" class="minus"><input type="number" step="1" min="0" max="3" name="quantity" value="0" title="Qty" class="input-text qty text" size="4" pattern="" inputmode=""><input type="button" value="+" class="plus">';
                    echo '</div>';
                    echo '</div>';
                }
                ?>
